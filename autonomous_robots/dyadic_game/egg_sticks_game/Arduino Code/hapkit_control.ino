//--------------------------------------------------------------------------
// Project: Collaborative tracking task
// This code includes the ROS node corresponding to the haptic joystick
// Developer: Saber Sheybani, Roth Lab, Indiana University
// Code adapted from Hapkit basic test (Tania Morimoto and Allison Okamura, Stanford University)
// 12.06.19
//--------------------------------------------------------------------------
...
ros::Publisher pub_handle("handle_pos", &pos_msg);
...
void loop()
{
  ...
  // Lab 4 Step 2.3: compute handle velocity
     ...
     pos_msg.data = 100*xh; //ts; //rawPos; //
     pub_handle.publish(&pos_msg);
     delay(1000);
